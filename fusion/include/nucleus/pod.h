...
#ifndef _RTAI_NUCLEUS_POD_H
#define _RTAI_NUCLEUS_POD_H
...
#ifdef CONFIG_RTAI_OPT_SCALABLE_SCHED
...
#else /* ! CONFIG_RTAI_OPT_SCALABLE_SCHED */
...
{
    xnarch_declare_cpuid;
    xnthread_t *thread;
    spl_t s;

    xnarch_get_cpu(s);
    thread = xnpod_sched_slot(cpuid)->runthread;
    xnarch_put_cpu(s);
