...
RTAI_PROTO_ALWAYS_INLINE(int, rt_spset_callback_fun, (unsigned int tty, void (*callback_fun)(int, int), int rxthrs, int txthrs))
{
	int ret;
	pthread_t thread;
	struct { int tty; void *callback_fun; int rxthrs, txthrs, code; void *task; } arg = { tty, (void *)callback_fun, rxthrs, txthrs, _SPSET_CALLBACK, 0 };
...
RTAI_PROTO_ALWAYS_INLINE(int, rt_spset_err_callback_fun, (unsigned int tty, void (*err_callback_fun)(int)))
{
	int ret;
	pthread_t thread;
	struct { int tty; void *err_callback_fun; int dummy1, dummy2, code; void *task; } arg = { tty, (void *)err_callback_fun, 0, 0, _SPSET_ERR_CALLBACK, 0 };
