...
int main(int ac, char *av[])
{
	...
	/* Determine GUI path */
 	...
 	glade_file = g_strconcat(srctree ?: ".", "/rtai-core/config/kconfig/",av[0], ".glade", NULL);
	...
	sym = sym_lookup("RTAI_VERSION",0);
	sym_calc_value(sym);
	sprintf(title, "RTAI Configuration [ %s ]",sym_get_string_value(sym));
