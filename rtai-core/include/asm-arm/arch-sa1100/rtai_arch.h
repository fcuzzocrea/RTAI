...
#define ARCH_MUX_IRQ		IRQ_GPIO11_27
...
//	free_irq( IRQ_GPIO11_27 );
	rt_request_global_irq_ext( IRQ_GPIO11_27, rtai_sa1100_GPIO11_27_demux, NULL );
}
...
#define isdemuxirq(irq) (irq >= IRQ_GPIO11)
