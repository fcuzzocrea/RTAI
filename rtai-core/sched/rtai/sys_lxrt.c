...

{
    ...
    lpath = test_bit(hard_cpu_id(),&lxrt_hrt_flags) || test_bit(hard_cpu_id(),&arti_cpu_realtime);
#else /* CONFIG_RTHAL */
    lpath = test_bit(hard_cpu_id(),&lxrt_hrt_flags) || !test_bit(hard_cpu_id(),&global.used_by_linux);
