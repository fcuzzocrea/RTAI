...
void out_rtai_scope_init(int port,int nch,char * sName);
...
void out_rtai_comedi_dio_init(int port,int nch,char * sName,double threshold);
...
void inp_mbx_receive_if_init(int port,int nch,char * sName,char * IPs);
