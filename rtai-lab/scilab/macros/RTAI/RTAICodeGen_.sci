...
//
  ...
  label1=[hname;getcwd()+'/'+hname+"_rtai";sTsamp;archname];
  while %t do
    [okk,rdnom,rpat,Tsamp,archname,label1]=getvalue(..
...
function Makename=gen_make(name,files,libs,Makename)
  ...
  T=["# Please do not edit this file"
     ...
     "OTHERLIBS = "+libs
     "ULIBRARY = $(RTAIDIR)/lib/libsciblk.a $(RTAIDIR)/lib/liblxrt.a " + archname
     ""
