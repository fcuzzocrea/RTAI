/*
  ...
  COPYRIGHT (C) 2002  Roberto Bucher (roberto.bucher@supsi.ch)
  COPYRIGHT (C) 2002  Daniele Gasperini (daniele.gasperini@elet.polimi.it)
  COPYRIGHT (C) 2002  Guillaume Millet <millet@isir.fr>
